    ...
    public partial class BaseDb : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.ApTypes", t => t.ApTypeId)
                .Index(t => t.ApTypeId);
                ...
                c => new
                    {
                        ...
                        Name = c.String(nullable: false),
                        Suname = c.String(nullable: false),
                        Email = c.String(nullable: false),
                        PhoneNumber = c.String(nullable: false),
                        ReservationPriсe = c.Decimal(nullable: false, precision: 18, scale: 2),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Apartments", "ApTypeId", "dbo.ApTypes");
            ...
            DropIndex("dbo.Apartments", new[] { "ApTypeId" });
